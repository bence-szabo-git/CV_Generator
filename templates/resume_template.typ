...
// ============================================================
// HELPER FUNCTIONS
// Left column is 11.16cm wide.
// experience-entry: 2.8cm dates + 8pt gutter + remainder for content
// education-entry: lives in right col (6.3cm), logo 1.2cm + 6pt gutter
// ============================================================
...
#let experience-entry(dates, location, role, role-color, bullets) = block(width: 100%)[
  #grid(
    columns: (2.8cm, 8.06cm),
    gutter: 0pt,
    align(left)[
      #pad(right: 8pt)[
...
#let education-entry(degree, university, location, dates, logo) = block(width: 100%)[
  #grid(
    columns: (4.8cm, 1.2cm),
    gutter: 0pt,
    align(left)[
...
// Total available: 18cm
// Left: 11.16cm | Gap: 0.54cm | Right: 6.3cm
// ============================================================
...
#grid(
  ...
  block(width: 11.16cm)[
    ...
    #for job in data.experience [
      #grid(
        columns: (1.2cm, 9.66cm),
        gutter: 0pt,
        align(top)[
          #if job.keys().contains("logo_path") and job.logo_path != "" [
            #pad(right: 6pt)[#image(job.logo_path, width: 1cm)]
          ]
        ],
        align(top)[
